...
const mainExperiences = [
  { id: 'lapis', company: 'LAPIS', role: 'Founder', start: '2025', end: '····', href: 'https://trylapis.com' },
  { id: 'walmart', company: 'WALMART', role: 'ML Engineer', start: '2023', end: '2025', href: 'https://www.walmart.com/' },
]

// Internship/Previous experience
const internshipExperiences = [
  { id: 'inquirer', company: 'INQUIRER', role: 'Data Engineer', start: '2021', end: '2021', href: 'https://www.inquirer.com/' },
  { id: 'amfam', company: 'AMFAM', role: 'ML Intern', start: '2020', end: '2021', href: 'https://www.amfam.com/' },
  { id: 'mindgram', company: 'MINDGRAM', role: 'ML Engineer', start: '2019', end: '2020', href: 'https://www.mindgram.ai/' },
  { id: 'stellenbosch', company: 'STELLENBOSCH', role: 'Research', start: '2019', end: '2019', href: 'https://www.sun.ac.za/english' },
  { id: 'aaa', company: 'AAA', role: 'Data Science', start: '2018', end: '2018', href: 'https://www.acg.aaa.com/' },
]

// Education data
const educationExperiences = [
  { id: 'columbia', company: 'COLUMBIA', role: 'MS CS', start: '2021', end: '2023', href: 'https://www.columbia.edu/' },
  { id: 'umich', company: 'UMICH', role: 'BSI', start: '2017', end: '2021', href: 'https://umich.edu/' },
]
...
function ExperienceRow({ experience, onHover, isHovered }) {
  return (
    ...
    >
      <span className="font-mono text-sm uppercase tracking-wide">{experience.company}</span>
  ...
  return (
    <div className={containerClasses}>
      ...
      <div className="flex-1 max-w-md z-10">
        ...
        {/* Name & Title */}
        <div className="mb-12">
          <h1 className="text-lg font-mono uppercase tracking-wide mb-1">SAI SURBEHERA</h1>
          <p className="text-sm font-mono uppercase tracking-wide opacity-70">POET ENGINEER</p>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className={`overflow-hidden transition-all duration-300 ease-in-out ${showInternships ? 'max-h-96 opacity-100 mt-2' : 'max-h-0 opacity-0'}`}>
        ...
        <div className="mb-12">
          {externalLinks.map((link) => (
            <LinkRow key={link.title} title={link.title} href={link.href} isExternal />
          ))}
        </div>
